...
export class Solana {
  public static parse(id: string): SolanaParams {
    let params: SolanaParams = {
      namespace: null,
      reference: null,
      chainId: null,
      address: null,
    ...
    return new Solana(params).toJSON();
  }

  public static format(params: SolanaParams): string {
  ...
  public toString(): string {
    return Solana.format(this.toJSON());
  }

  public toJSON(): SolanaParams {
    const json: SolanaParams = {};
